...
YUI.add('running-tests', function(Y) {

    var suite = new YUITest.TestSuite('running-tests'),
        controller = null,
        A = YUITest.Assert;
    ...
    suite.add(new YUITest.TestCase({
        ...
        setUp: function() {
            controller = Y.mojito.controllers.running;
        },
        tearDown: function() {
            controller = null;
        },
...
}, '0.0.1', {requires: ['mojito-test', 'running']});
